...
public interface InventoryRepository extends JpaRepository<Inventory, Long> {
        ...
        //TODO: i have to understand thiss query and flow of this query
...
//TODO: i have to understand why i have created this findAndLockReservedInventory and what is the main difference betweem findAndLockAvailableInventory and findAndLockReservedInventory
        @Query("""
                SELECT i
                FROM Inventory i
                WHERE i.room.id = :roomId
        ...
        @Modifying //when ever write this annotation that means that we are going to update the data in database and in this annotation i cannot use the Locking mechanism because we are going to update the data in database and locking mechanism is used when we are going to read the data from database
        @Query("""
                UPDATE Inventory i
                SET i.reservedCount = i.reservedCount - :numberOfRooms,
                ...
                WHERE i.room.id = :roomId
                  ...
                  AND i.closed = false
            """) //now here we have decreased the reserved count and increase the bookcount so this query will do that
        ...
        void cancelBooking(@Param("roomId") Long roomId,
                           ...
                           @Param("endDate") LocalDate endDate,
                           @Param("numberOfRooms") int numberOfRooms);
        //TODO: to understand the quesry the of the cancel booking and flow of the cancel booking
