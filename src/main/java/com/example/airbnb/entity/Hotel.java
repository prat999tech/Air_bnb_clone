...
public class Hotel {
    ...
    // hotel
    @ManyToOne(optional = false)// here optional is false because every hotel must have an owner and if we do not add this line then by default it is true and it will allow us to create a hotel without an owner which is not what we want
    private user owner;
