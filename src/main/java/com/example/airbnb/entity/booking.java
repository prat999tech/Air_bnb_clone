...
import jakarta.persistence.ManyTo
...
public class booking extends Auditableclass {
    ...
    @Column(unique = true)
    private String sessionId; // this field will store the session id returned by payment gateway after successful payment which will be used to verify the payment status in webhook and update the booking status accordingly
}
