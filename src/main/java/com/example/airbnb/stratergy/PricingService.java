...
public class PricingService {
    ...
    public BigDecimal calculateTotalPrice(List<Inventory> inventoryList){ //TODO:understand this code why we have done this thing and flow of this code and also the logic in this code line by line
